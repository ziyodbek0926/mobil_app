...
def main(page: ft.Page):
    ...
    def sign_in(user: str, password: str):
        ...
        if not db.read_db(user, password):
            ...
            print("Suhbatga yoʻnaltirilmoqda...")
            page.session.set("user", user)
            page.route = "/chat"
            page.pubsub.send_all(
                Message(
                    user=user,
                    text=f"{user} chatga qo'shildi.",
    ...
    def sign_up(user: str, password: str):
        ...
        if db.write_db(user, password):
            print("Foydalanuvchi muvaffaqqiyatli qo'shildi...")
            open_dlg()
    ...
    page.banner = ft.Banner(
        ...
        content=ft.Text("Kirish amalga oshmadi, foydalanuvchi nomi yoki parol noto'g'ri"),
        actions=[
